    ...
    public class KYCONGCHITIET
    {
        ...
        public void phatSinhKyCongChiTiet(int macty, int thang, int nam)
        {
            ...
            foreach (var item in lstNV)
            {
                ...
                for (int j = 1; j <= GetDayNumber(thang, nam); j++) // Lấy ra ngày trong tháng và phát sinh ra các ngày công
                {
                ...
                switch (listDay.Count) // tương ứng theo tháng add thêm số cột trống đủ 31 ngày
                {
                    case 28:
                        listDay.Add("");
                        listDay.Add("");
