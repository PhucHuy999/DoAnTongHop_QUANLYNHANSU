...
namespace QLNHANSU.Reports
{
    public partial class rptDanhSachNhanVien : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        void loadData()
        {
            lblMaNV.DataBindings.Add("Text", _lstNV, "MANV");// (truyền vào kiểu dữ liệu, datasource(_lstNV đã dựng), datamember(tên trường))
            ...
            lblTonGiao.DataBindings.Add("Text", _lstNV, "TENTD");
